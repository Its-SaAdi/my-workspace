...
const WorkspaceClock = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center py-4 mx-auto w-[340px] mt-20  text-zinc-50 select-none transition-all duration-500 backdrop-blur-lg bg-white/10 p-6 rounded-2xl shadow-lg border border-white/10">
            <div className="mb-2">
            ...
            <div className="flex items-center justify-center space-x-2 mt-1">
                ...
                {/* AM / PM Indicator */}
                <div className="flex flex-col text-sm font-semibold ml-2 leading-tight bg-zinc-950/40 rounded-lg overflow-hidden">
                    <span
